...
namespace MiPrimerWindowsForm
{
    public partial class Form1 : Form
    {
        ...
        public void remoteSetup() {
            ...
            Type requiredType = typeof(iCalcLogic);
            iCalcLogic remoteCalculator = (iCalcLogic)Activator.GetObject(requiredType, "tcp://localhost:9998/RemoteCalcLogic");
            calculadora = remoteCalculator;
